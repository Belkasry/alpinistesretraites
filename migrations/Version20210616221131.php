 ...
 */
final class Version20210616221131 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, guide_id INT DEFAULT NULL, destination_id INT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, dificulte SMALLINT DEFAULT NULL, nbr_participant INT DEFAULT NULL, nbr_participant_restant INT DEFAULT NULL, prix NUMERIC(10, 0) NOT NULL, description LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, etat TINYINT(1) NOT NULL, fixe TINYINT(1) NOT NULL, start DATETIME DEFAULT NULL, finish DATETIME DEFAULT NULL, INDEX IDX_590C103816C6140 (destination_id), INDEX IDX_590C103D7ED1D4B (guide_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE step_experience (id INT AUTO_INCREMENT NOT NULL, experience_id INT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, resume VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, duree INT NOT NULL, INDEX IDX_9FBE74246E90E27 (experience_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE step_experience');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
